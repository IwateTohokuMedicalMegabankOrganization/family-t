import { FiveDiseaseRiskCommonsGetter } from '../../../../js/modules/5DiseaseRisk/5DiseaseRiskCommonsGetter';
...
test('getDisease', () => {
    ...
    // 取得できる場合
    var disease = FiveDiseaseRiskCommonsGetter.getDisease('SNOMED_CT-38341003', pi);
    if(disease != null) expect(true).toEqual(true);
    else expect(true).toEqual(false);

    // 取得できない場合
    var disease = FiveDiseaseRiskCommonsGetter.getDisease('高SNOMED_CT-XXXXXXXX', pi);
    if(disease == null) expect(true).toEqual(true);
    else expect(true).toEqual(false);
});
...
test('getHealthHistory', () => {
    ...
    expect(FiveDiseaseRiskCommonsGetter.getHealthHistory('', personalInformation)).toEqual(expect1);
    ...
    expect(FiveDiseaseRiskCommonsGetter.getHealthHistory('father', personalInformation)).toEqual(expect2);

    // grandson(存在しない)のHealthHistory
    var expect3 = null;
    expect(FiveDiseaseRiskCommonsGetter.getHealthHistory('grandson', personalInformation)).toEqual(expect3);

    // nullのHealthHistory
    var param = null;
    var expect3 = null;
    expect(FiveDiseaseRiskCommonsGetter.getHealthHistory(param, personalInformation)).toEqual(expect3);
