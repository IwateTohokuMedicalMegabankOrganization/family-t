...
//		if (isset($low) && reset($low) == '10') return "teen";
		if (isset($low) && reset($low) == '10') return "early_teen";
		if (isset($low) && reset($low) == '15') return "late_teen";
//		if (isset($low) && reset($low) == '20') return "twenties";
		if (isset($low) && reset($low) == '20') return "early_twenties";
		if (isset($low) && reset($low) == '25') return "late_twenties";
//		if (isset($low) && reset($low) == '30') return "thirties";
		if (isset($low) && reset($low) == '30') return "early_thirties";
		if (isset($low) && reset($low) == '35') return "late_thirties";
//		if (isset($low) && reset($low) == '40') return "fourties";
		if (isset($low) && reset($low) == '40') return "early_fourties";
		if (isset($low) && reset($low) == '45') return "late_fourties";
//		if (isset($low) && reset($low) == '50') return "fifties";
		if (isset($low) && reset($low) == '50') return "early_fifties";
		if (isset($low) && reset($low) == '55') return "late_fifties";
...
//		if (estimated_age.indexOf('value="10"') > -1) return "teen";
		if (estimated_age.indexOf('value="10"') > -1) return "early_teen";
		if (estimated_age.indexOf('value="15"') > -1) return "late_teen";
//		if (estimated_age.indexOf('value="20"') > -1) return "twenties";
		if (estimated_age.indexOf('value="20"') > -1) return "early_twenties";
		if (estimated_age.indexOf('value="25"') > -1) return "late_twenties";
//		if (estimated_age.indexOf('value="30"') > -1) return "thirties";
		if (estimated_age.indexOf('value="30"') > -1) return "early_thirties";
		if (estimated_age.indexOf('value="35"') > -1) return "late_thirties";
//		if (estimated_age.indexOf('value="40"') > -1) return "fourties";
		if (estimated_age.indexOf('value="40"') > -1) return "early_fourties";
		if (estimated_age.indexOf('value="45"') > -1) return "late_fourties";
//		if (estimated_age.indexOf('value="50"') > -1) return "fifties";
		if (estimated_age.indexOf('value="50"') > -1) return "early_fifties";
		if (estimated_age.indexOf('value="55"') > -1) return "late_fifties";
